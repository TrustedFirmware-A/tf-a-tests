 ...
 * arg1 == base address
 * arg2 == top address
 * arg3 == flags (RmiRttUnprotMapFlags)
...
#define RMI_FEATURE_REGISTER_2_DA_EN			BIT(0)
...
/* RmiRttUnprotMapFlags field shifts */
#define RMI_UNPROT_MAP_FLAGS_OADDR_TYPE_SHIFT	(0UL)
#define RMI_UNPROT_MAP_FLAGS_OADDR_TYPE_WIDTH	(2)
#define RMI_UNPROT_MAP_FLAGS_LIST_COUNT_SHIFT	(2UL)
#define RMI_UNPROT_MAP_FLAGS_LIST_COUNT_WIDTH	(14)
#define RMI_UNPROT_MAP_FLAGS_MEMATTR_SHIFT	(16UL)
#define RMI_UNPROT_MAP_FLAGS_MEMATTR_WIDTH	(3)
 ...
 * Encoding for indirect S2AP base index value for UNPROTECTED IPA
 */
...
/*
 * Direct S2AP encoding value for RW + XN permissions in
 * RmiRttUnprotMapFlags.s2ap.
 */
#define RMI_UNPROT_MAP_S2AP_RW_XN		U(3)
...
#define RMI_DEV_COMM_EXIT_FLAGS_RESET_RSP_SHIFT		UL(4)
#define RMI_DEV_COMM_EXIT_FLAGS_RESET_RSP_WIDTH		UL(1)
#define RMI_DEV_COMM_EXIT_FLAGS_MULTI_SHIFT		UL(5)
#define RMI_DEV_COMM_EXIT_FLAGS_MULTI_WIDTH		UL(1)
#define RMI_DEV_COMM_EXIT_FLAGS_STREAM_WAIT_SHIFT	UL(6)
#define RMI_DEV_COMM_EXIT_FLAGS_STREAM_WAIT_WIDTH	UL(1)
 ...
 * Width: 8 bits
 */
#define RMI_PDEV_STREAM_NON_TEE			U(0)
#define RMI_PDEV_STREAM_NCOH			U(1)
#define RMI_PDEV_STREAM_COH			U(2)
#define RMI_PDEV_STREAM_NCOH_SYS		U(3)
#define RMI_PDEV_STREAM_COH_SYS			U(4)
...
struct rmi_pdev_stream_params {
	...
	SET_MEMBER_RMI(struct rmi_address_range
		addr_range[RMI_PDEV_STREAM_ADDR_RANGE_CNT], 0x100, 0x1000);
};
