...
DEFINE_SYSREG_RW_FUNCS(cntp_tval_el02)
...
DEFINE_RENAME_SYSREG_RW_FUNCS(icv_ctlr_el1, ICV_CTLR_EL1)
...
DEFINE_RENAME_SYSREG_RW_FUNCS(icv_dir_el1, ICV_DIR_EL1)

#define IS_ISS_SYSREG_READ(iss) \
	((((iss) >> ISS_SYSREG_DIRECTION_SHIFT) & \
	  ISS_SYSREG_DIRECTION_MASK) == ISS_SYSREG_DIRECTION_READ)

#define IS_ISS_SYSREG_WRITE(iss) \
	((((iss) >> ISS_SYSREG_DIRECTION_SHIFT) & \
	  ISS_SYSREG_DIRECTION_MASK) == ISS_SYSREG_DIRECTION_WRITE)
...
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff00_el2, AMEVCNTVOFF00_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff02_el2, AMEVCNTVOFF02_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff03_el2, AMEVCNTVOFF03_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff10_el2, AMEVCNTVOFF10_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff11_el2, AMEVCNTVOFF11_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff12_el2, AMEVCNTVOFF12_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff13_el2, AMEVCNTVOFF13_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff14_el2, AMEVCNTVOFF14_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff15_el2, AMEVCNTVOFF15_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff16_el2, AMEVCNTVOFF16_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff17_el2, AMEVCNTVOFF17_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff18_el2, AMEVCNTVOFF18_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff19_el2, AMEVCNTVOFF19_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff1a_el2, AMEVCNTVOFF1A_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff1b_el2, AMEVCNTVOFF1B_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff1c_el2, AMEVCNTVOFF1C_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff1d_el2, AMEVCNTVOFF1D_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff1e_el2, AMEVCNTVOFF1E_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevcntvoff1f_el2, AMEVCNTVOFF1F_EL2)
...
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper00_el0, AMEVTYPER00_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper01_el0, AMEVTYPER01_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper02_el0, AMEVTYPER02_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper03_el0, AMEVTYPER03_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper10_el0, AMEVTYPER10_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper11_el0, AMEVTYPER11_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper12_el0, AMEVTYPER12_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper13_el0, AMEVTYPER13_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper14_el0, AMEVTYPER14_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper15_el0, AMEVTYPER15_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper16_el0, AMEVTYPER16_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper17_el0, AMEVTYPER17_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper18_el0, AMEVTYPER18_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper19_el0, AMEVTYPER19_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper1a_el0, AMEVTYPER1A_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper1b_el0, AMEVTYPER1B_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper1c_el0, AMEVTYPER1C_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper1d_el0, AMEVTYPER1D_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper1e_el0, AMEVTYPER1E_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(amevtyper1f_el0, AMEVTYPER1F_EL0)
...
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr1_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr2_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr3_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr4_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr5_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr6_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr7_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr8_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr9_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr10_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr11_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr12_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr13_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr14_el2, ICH_LR0_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_lr15_el2, ICH_LR0_EL2)
...
/* FEAT_SPE_EXC */
DEFINE_RENAME_SYSREG_RW_FUNCS(pmbsr_el2, PMBSR_EL2)

/* FEAT_SPE_nVM */
DEFINE_RENAME_SYSREG_RW_FUNCS(pmbmar_el1, PMBMAR_EL1)
...
DEFINE_RENAME_SYSREG_READ_FUNC(cpu_erxpfgf_el1, ERXPFGF_EL1)
DEFINE_RENAME_SYSREG_RW_FUNCS(cpu_erxpfgctl_el1, ERXPFGCTL_EL1)
DEFINE_RENAME_SYSREG_RW_FUNCS(cpu_erxpfgcdn_el1, ERXPFGCDN_EL1)
...
DEFINE_RENAME_SYSREG_RW_FUNCS(trbsr_el2, TRBSR_EL2)
...
/* FEAT_SRMASK Registers */
DEFINE_RENAME_SYSREG_RW_FUNCS(sctlrmask_el1, SCTLRMASK_EL1)
...
DEFINE_RENAME_SYSREG_RW_FUNCS(ttbr0_el12, TTBR0_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(ttbr1_el12, TTBR1_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(vbar_el12, VBAR_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(tcr_el12, TCR_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(sctlr_el12, SCTLR_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(far_el12, FAR_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(mair_el12, MAIR_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(cpacr_el12, CPACR_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(contextidr_el12, CONTEXTIDR_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(esr_el12, ESR_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(amair_el12, AMAIR_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(afsr0_el12, AFSR0_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(afsr1_el12, AFSR1_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(elr_el12, ELR_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(spsr_el12, SPSR_EL12);
DEFINE_RENAME_SYSREG_RW_FUNCS(cntkctl_el12, CNTKCTL_EL12);
