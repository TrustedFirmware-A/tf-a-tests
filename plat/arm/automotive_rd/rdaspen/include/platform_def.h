...
/* PLATFORM_CORE_COUNT default is provided by the platform makefile. */
#if (PLATFORM_CORE_COUNT > 16) || (PLATFORM_CORE_COUNT == 0)
#error "Invalid number of platform's cores was passed."
#endif /* 1 <= PLATFORM_CORE_COUNT <= 16 */

#if (PLATFORM_CORE_COUNT <= 4)
#define PLATFORM_CLUSTER_0_CORE_COUNT		(PLATFORM_CORE_COUNT)
#define PLATFORM_CLUSTER_1_CORE_COUNT		0
#define PLATFORM_CLUSTER_2_CORE_COUNT		0
#define PLATFORM_CLUSTER_3_CORE_COUNT		0

#else /* PLATFORM_CORE_COUNT <= 4 */
#define PLATFORM_CLUSTER_0_CORE_COUNT		4

#if (PLATFORM_CORE_COUNT <= 8)
#define PLATFORM_CLUSTER_1_CORE_COUNT		(PLATFORM_CORE_COUNT - 4)
#define PLATFORM_CLUSTER_2_CORE_COUNT		0
#define PLATFORM_CLUSTER_3_CORE_COUNT		0

#else /* PLATFORM_CORE_COUNT <= 8 */
#define PLATFORM_CLUSTER_1_CORE_COUNT		4

#if (PLATFORM_CORE_COUNT <= 12)
#define PLATFORM_CLUSTER_2_CORE_COUNT		(PLATFORM_CORE_COUNT - 8)
#define PLATFORM_CLUSTER_3_CORE_COUNT		0

#else /* PLATFORM_CORE_COUNT <= 12 */
#define PLATFORM_CLUSTER_2_CORE_COUNT		4
#define PLATFORM_CLUSTER_3_CORE_COUNT		(PLATFORM_CORE_COUNT - 12)
...
#define PLATFORM_CLUSTER_COUNT			((PLATFORM_CORE_COUNT + \
