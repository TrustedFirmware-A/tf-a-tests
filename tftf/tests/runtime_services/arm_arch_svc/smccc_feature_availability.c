...
test_result_t test_smccc_arch_feature_availability(void)
{
	...
	CHECK_BIT_SET(is_feat_idte3_present,			SCR_TID3_BIT);
	CHECK_BIT_SET(is_feat_idte3_present,			SCR_TID5_BIT);
	...
	CHECK_BIT_SET(is_feat_trbe_exc_present,			MDCR_TRBEE_EN_BIT);
