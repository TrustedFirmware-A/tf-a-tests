...
DEFINE_COPROCR_RW_FUNCS(cntp_ctl_el0, CNTP_CTL)
DEFINE_COPROCR_RW_FUNCS(cntp_tval_el0, CNTP_TVAL)
DEFINE_COPROCR_RW_FUNCS_64(cntp_cval_el0, CNTP_CVAL_64)
...
DEFINE_COPROCR_RW_FUNCS(amevtyper00, AMEVTYPER00)
DEFINE_COPROCR_RW_FUNCS(amevtyper01, AMEVTYPER01)
DEFINE_COPROCR_RW_FUNCS(amevtyper02, AMEVTYPER02)
DEFINE_COPROCR_RW_FUNCS(amevtyper03, AMEVTYPER03)
DEFINE_COPROCR_RW_FUNCS(amevtyper10, AMEVTYPER10)
DEFINE_COPROCR_RW_FUNCS(amevtyper11, AMEVTYPER11)
DEFINE_COPROCR_RW_FUNCS(amevtyper12, AMEVTYPER12)
DEFINE_COPROCR_RW_FUNCS(amevtyper13, AMEVTYPER13)
DEFINE_COPROCR_RW_FUNCS(amevtyper14, AMEVTYPER14)
DEFINE_COPROCR_RW_FUNCS(amevtyper15, AMEVTYPER15)
DEFINE_COPROCR_RW_FUNCS(amevtyper16, AMEVTYPER16)
DEFINE_COPROCR_RW_FUNCS(amevtyper17, AMEVTYPER17)
DEFINE_COPROCR_RW_FUNCS(amevtyper18, AMEVTYPER18)
DEFINE_COPROCR_RW_FUNCS(amevtyper19, AMEVTYPER19)
DEFINE_COPROCR_RW_FUNCS(amevtyper1a, AMEVTYPER1A)
DEFINE_COPROCR_RW_FUNCS(amevtyper1b, AMEVTYPER1B)
DEFINE_COPROCR_RW_FUNCS(amevtyper1c, AMEVTYPER1C)
DEFINE_COPROCR_RW_FUNCS(amevtyper1d, AMEVTYPER1D)
DEFINE_COPROCR_RW_FUNCS(amevtyper1e, AMEVTYPER1E)
DEFINE_COPROCR_RW_FUNCS(amevtyper1f, AMEVTYPER1F)
...
#define read_cntp_cval_el0()	read64_cntp_cval_el0()
#define write_cntp_cval_el0(v)	write64_cntp_cval_el0(v)
