...
$(error tests-versal-force_powerdown.mk: PLAT=$(PLAT) is not supported; AMD_XILINX_TEST_ALLOWED_PLATS = $(AMD_XILINX_TEST_ALLOWED_PLATS))
endif

include tftf/tests/tests-versal-common.mk

TESTS_SOURCES		+=	$(wildcard tftf/tests/plat/amd/common/force_powerdown/*.c)
